(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.MitchAllen || (g.MitchAllen = {})).MazeGeneratorV2 = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(_dereq_,module,exports){
...
/**
    Module: connection-grid-core/src/index.js
    Author: Mitch Allen
*/
...
var shuffleFactory = _dereq_("shuffle");

/**
 * Grid Core
 * @external grid-core
 * @see {@link https://www.npmjs.com/package/grid-core|grid-core}
 */

/**
 * Connection Grid Core generated by {@link module:connection-grid-core-factory|create}
 * @module connection-grid-core
 * @extends external:grid-core
 */
...
* @param {grid} options.grid Grid based on {@link external:grid-core|grid-core}
...
* "use strict";
* var gridFactory = require("connection-grid-core"),
...
},{"shuffle":2}],2:[function(_dereq_,module,exports){
(function (global){(function (){
...
/**
    Module: connection-grid-square/src/index.js
    Author: Mitch Allen
*/
...
var gridFactory = _dereq_("grid-square"),
    baseGrid = _dereq_("connection-grid-core").create;

/**
 * Connection Grid Core
 * @external connection-grid-core
 * @see {@link https://www.npmjs.com/package/connection-grid-core|connection-grid-core}
 */

/**
* Connection Grid Square generated by {@link module:connection-grid-square-factory|create}
* @module connection-grid-square
* @extends external:connection-grid-core
*/
...
* "use strict";
* var gridFactory = require("connection-grid-square");
* let xSize = 5;
* let ySize = 6;
...
},{"connection-grid-core":1,"grid-square":3}],3:[function(_dereq_,module,exports){
"use strict";
...
// ../grid-core/dist/grid-core.cjs.js
var require_grid_core_cjs = __commonJS({
  "../grid-core/dist/grid-core.cjs.js"(exports2, module2) {
    "use strict";
...
},{"connection-grid-core":1,"grid":7}],4:[function(_dereq_,module,exports){
/**
...
},{"connection-grid-core":1,"grid":7}],5:[function(_dereq_,module,exports){
/**
...
var squareGrid = _dereq_('connection-grid-square').create,
...
},{"./circle":3,"./hexagon":4,"./triangle":6,"connection-grid-square":2}],6:[function(_dereq_,module,exports){
/**
...
},{"connection-grid-core":1,"grid":7}],7:[function(_dereq_,module,exports){
(function (global){(function (){
...
"use strict";module.exports.create=(u={})=>{let{rows:t=0}=u;t=Math.max(t,0);for(var i=[];i.push([])<t;);var a=Object.create({},{rows:{writeable:!1,value:t,enumerable:!0}});return Object.assign(a,{log:function(){console.log("size: %d: ",t),console.log(i)},rowSize:function(e){return e<0||e>=t?0:i[e].length},isCell:function(e,r){var l=this.rowSize(e);return e>=0&&e<t&&r>=0&&r<l},set:function(e,r,l){return e<0||r<0?!1:(i[e][r]=l,!0)},get:function(e,r){return this.isCell(e,r)?i[e][r]:null},fill:function(e){for(var r=0;r<t;r++)for(var l=this.rowSize(r),n=0;n<l;n++)i[r][n]=e},cloneArray:function(){for(var e=[];e.push([])<t;);for(var r=0;r<t;r++)for(var l=this.rowSize(r),n=0;n<l;n++)e[r][n]=i[r][n];return e}})};
...
var coreGrid = _dereq_('grid-core');
...
},{"grid-core":1}],4:[function(_dereq_,module,exports){
/**
    Module: grid
    Author: Mitch Allen
*/
...
var squareGrid = _dereq_('grid-square').create,
  circleGrid = _dereq_('./circle');
var createGrid = function createGrid(spec) {
...
/**
    Module: maze-generator-core/modules/index
    Author: Mitch Allen
*/
...
* @param {grid} options.grid Grid based on {@link external:connection-grid-core|connection-grid-core}
...
var cgFactory = _dereq_("connection-grid-square"),
    baseGrid = _dereq_("maze-generator-core");
...
},{"connection-grid-square":1,"maze-generator-core":2}]},{},[3])(3)
});
...
},{"grid":2}],6:[function(_dereq_,module,exports){
/**
...
var connectionGridFactory = _dereq_("connection-grid"),
  baseGrid = _dereq_("maze-generator-core");
module.exports = function (spec) {
  spec = spec || {};
  var _rings = spec.rings || 0;
...
},{"connection-grid":1,"maze-generator-core":3}],7:[function(_dereq_,module,exports){
/**
...
},{"./ascii-canvas":5,"connection-grid":1,"maze-generator-core":3}],8:[function(_dereq_,module,exports){
/**
...
var squareMaze = _dereq_('maze-generator-square').create,
...
},{"./circle":6,"./hexagon":7,"./triangle":9,"maze-generator-square":4}],9:[function(_dereq_,module,exports){
/**
...
},{"./ascii-canvas":5,"connection-grid":1,"maze-generator-core":3}]},{},[8])(8)
});
