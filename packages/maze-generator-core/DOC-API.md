...
<dl>
<dt><a href="#module_maze-generator-core">maze-generator-core</a> ⇐ <code><a href="#external_@mitchallen/connection-grid-core-v2">@mitchallen/connection-grid-core-v2</a></code></dt>
...
<dl>
<dt><a href="#external_@mitchallen/connection-grid-core-v2">@mitchallen/connection-grid-core-v2</a></dt>
...
## maze-generator-core ⇐ <code>[@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2)</code>
Maze Generator Core generated by [create](#module_maze-generator-core-factory)

**Extends:** <code>[@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2)</code>  

* [maze-generator-core](#module_maze-generator-core) ⇐ <code>[@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2)</code>
...
| options.grid | <code>grid</code> | Grid based on [@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2) |
...
```
<a name="external_@mitchallen/connection-grid-core-v2"></a>

## @mitchallen/connection-grid-core-v2
Connection Grid Core

**Kind**: global external  
**See**: [@mitchallen/connection-grid-core-v2](https://www.npmjs.com/package/@mitchallen/connection-grid-core-v2)  
