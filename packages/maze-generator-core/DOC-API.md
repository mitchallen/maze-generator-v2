...
<dl>
<dt><a href="#module_maze-generator-core">maze-generator-core</a> ⇐ <code><a href="#external_connection-grid-core">connection-grid-core</a></code></dt>
...
<dl>
<dt><a href="#external_connection-grid-core">connection-grid-core</a></dt>
...
## maze-generator-core ⇐ [<code>connection-grid-core</code>](#external_connection-grid-core)
Maze Generator Core generated by [create](#module_maze-generator-core-factory)

**Extends**: [<code>connection-grid-core</code>](#external_connection-grid-core)  

* [maze-generator-core](#module_maze-generator-core) ⇐ [<code>connection-grid-core</code>](#external_connection-grid-core)
...
**Kind**: instance method of [<code>maze-generator-core</code>](#module_maze-generator-core)  
...
### maze-generator-core-factory.create(options) ⇒ [<code>maze-generator-core</code>](#module_maze-generator-core)
Factory method that returns a maze generator core object.
It takes one spec parameter that must be an object with named parameters.

**Kind**: static method of [<code>maze-generator-core-factory</code>](#module_maze-generator-core-factory)  

| Param | Type | Description |
| --- | --- | --- |
| options | <code>Object</code> | Named parameters for generating a maze generator core |
| options.grid | <code>grid</code> | Grid based on [connection-grid-core](#external_connection-grid-core) |
...
```
<a name="external_connection-grid-core"></a>

## connection-grid-core
Connection Grid Core

**Kind**: global external  
**See**: [connection-grid-core](https://www.npmjs.com/package/connection-grid-core)  
