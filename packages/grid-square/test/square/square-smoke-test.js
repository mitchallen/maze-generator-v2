...
describe('module smoke test', function() {
   ...
   it('cloneArray method should return a clone of the internal array', function() {
    ...
    it('rowSize should return row size for new grid', function() {
        let xSize = 4;
        let ySize = 5;
        var grid = _module.create({ x: xSize, y: ySize });
        assert.deepStrictEqual(grid.rowSize(xSize-1), ySize);
    });
    ...
    it('rowSize should return zero for max row value', function() {
        ...
        let ySize = 5;
        var grid = _module.create({ x: xSize, y: ySize });
        assert.deepStrictEqual(grid.rowSize(xSize), 0);
    });
});
