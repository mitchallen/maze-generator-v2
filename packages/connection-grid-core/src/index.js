/**
    Module: @mitchallen/connection-grid-core-v2/src/index.js
    Author: Mitch Allen
*/
...
/**
 * Grid Core
 * @external @mitchallen/grid-core-v2
 * @see {@link https://www.npmjs.com/package/@mitchallen/grid-core-v2|@mitchallen/grid-core-v2}
 */

/**
 * Connection Grid Core generated by {@link module:connection-grid-core-factory|create}
 * @module connection-grid-core
 * @extends external:@mitchallen/grid-core-v2
 */
...
* @param {grid} options.grid Grid based on {@link external:@mitchallen/grid-core-v2|@mitchallen/grid-core-v2}
