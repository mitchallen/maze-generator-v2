...
## connection-grid-core ⇐ [<code>@mitchallen/grid-core</code>](#external_@mitchallen/grid-core)
Connection Grid Core generated by [create](#module_connection-grid-core-factory)

**Extends**: [<code>@mitchallen/grid-core</code>](#external_@mitchallen/grid-core)  

* [connection-grid-core](#module_connection-grid-core) ⇐ [<code>@mitchallen/grid-core</code>](#external_@mitchallen/grid-core)
