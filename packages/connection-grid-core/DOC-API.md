...
<dl>
<dt><a href="#module_connection-grid-core">connection-grid-core</a> ⇐ <code><a href="#external_grid-core">grid-core</a></code></dt>
...
<dl>
<dt><a href="#external_grid-core">grid-core</a></dt>
<dd><p>Grid Core</p>
</dd>
</dl>
...
## connection-grid-core ⇐ [<code>grid-core</code>](#external_grid-core)
Connection Grid Core generated by [create](#module_connection-grid-core-factory)

**Extends**: [<code>grid-core</code>](#external_grid-core)  

* [connection-grid-core](#module_connection-grid-core) ⇐ [<code>grid-core</code>](#external_grid-core)
...
**Kind**: instance method of [<code>connection-grid-core</code>](#module_connection-grid-core)  
...
### connection-grid-core-factory.create(options) ⇒ [<code>connection-grid-core</code>](#module_connection-grid-core)
Factory method that returns a connection grid core object.
It takes one spec parameter that must be an object with named parameters.

**Kind**: static method of [<code>connection-grid-core-factory</code>](#module_connection-grid-core-factory)  

| Param | Type | Description |
| --- | --- | --- |
| options | <code>Object</code> | Named parameters for generating a connection grid core |
| options.grid | <code>grid</code> | Grid based on [grid-core](#external_grid-core) |
...
```
<a name="external_grid-core"></a>

## grid-core
Grid Core

**Kind**: global external  
**See**: [grid-core](https://www.npmjs.com/package/grid-core)  
