...
<dl>
<dt><a href="#module_connection-grid-core">connection-grid-core</a> ⇐ <code><a href="#external_@mitchallen/grid-core-v2">@mitchallen/grid-core-v2</a></code></dt>
...
<dl>
<dt><a href="#external_@mitchallen/grid-core-v2">@mitchallen/grid-core-v2</a></dt>
<dd><p>Grid Core</p>
</dd>
</dl>
...
## connection-grid-core ⇐ <code>[@mitchallen/grid-core-v2](#external_@mitchallen/grid-core-v2)</code>
Connection Grid Core generated by [create](#module_connection-grid-core-factory)

**Extends:** <code>[@mitchallen/grid-core-v2](#external_@mitchallen/grid-core-v2)</code>  

* [connection-grid-core](#module_connection-grid-core) ⇐ <code>[@mitchallen/grid-core-v2](#external_@mitchallen/grid-core-v2)</code>
...
| options.grid | <code>grid</code> | Grid based on [@mitchallen/grid-core-v2](#external_@mitchallen/grid-core-v2) |
...
```js
"use strict";
var gridFactory = require("@mitchallen/connection-grid-core-v2"),
...
```
<a name="external_@mitchallen/grid-core-v2"></a>

## @mitchallen/grid-core-v2
Grid Core

**Kind**: global external  
**See**: [@mitchallen/grid-core-v2](https://www.npmjs.com/package/@mitchallen/grid-core-v2)  
