...
<dl>
<dt><a href="#module_connection-grid-square">connection-grid-square</a> ⇐ <code><a href="#external_@mitchallen/connection-grid-core-v2">@mitchallen/connection-grid-core-v2</a></code></dt>
...
## connection-grid-square ⇐ <code>[@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2)</code>
...
* [connection-grid-square](#module_connection-grid-square) ⇐ <code>[@mitchallen/connection-grid-core-v2](#external_@mitchallen/connection-grid-core-v2)</code>
...
```js
"use strict";
var gridFactory = require("@mitchallen/connection-grid-square-v2");
let xSize = 5;
let ySize = 6;
