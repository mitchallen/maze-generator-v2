...
## connection-grid-square ⇐ [<code>@mitchallen/connection-grid-core</code>](#external_@mitchallen/connection-grid-core)
Connection Grid Square generated by [create](#module_connection-grid-square-factory)

**Extends**: [<code>@mitchallen/connection-grid-core</code>](#external_@mitchallen/connection-grid-core)  

* [connection-grid-square](#module_connection-grid-square) ⇐ [<code>@mitchallen/connection-grid-core</code>](#external_@mitchallen/connection-grid-core)
